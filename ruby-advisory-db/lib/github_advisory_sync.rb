...
# vvv UUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU
    ...
    def unaffected_versions_for(package)
      ...
      if !first_unaffected_versions.empty?
        first_unaffected_versions[0..-2].each do |version|
          unaffected_versions << "~> #{version}"
        end
puts "PUTS: #{first_unaffected_versions.is_a?}"
        if first_unaffected_versions.last[1] == "<"
          unaffected_versions << "LESS THAN: #{first_unaffected_versions.last}"
        else
          unaffected_versions << "NOT LESS THAN: #{first_unaffected_versions.last}"
        end
      end
